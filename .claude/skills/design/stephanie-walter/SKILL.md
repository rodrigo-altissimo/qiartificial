---
name: design-stephanie-walter
description: "Activate Stephanie Walter (stephanie-walter) - Stephanie Walter — Accessibility Documentation Specialist & UX Researcher. Use when creating accessibility documentation for components, annotating design mockups for a11y handoff, auditing existing accessibility documentation, generating WCAG-based checklists for designers, or bridging the gap between design intent and accessible implementation"
user-invocable: true
activation_type: pipeline
---

<\!-- ACORE-CLAUDE-AGENT-SKILL: generated -->
<\!-- Source: squads/design/agents/stephanie-walter.md -->
