...
description: "Activate Brad Frost (brad-frost) - Brad Frost — Creator of Atomic Design & Design Systems Architect. Use when auditing design systems, decomposing interfaces into components, building pattern libraries, calculating design system ROI, or any task requiring systematic component-based thinking"
user-invocable: true
activation_type: pipeline
---

<\!-- ACORE-CLAUDE-AGENT-SKILL: generated -->
<\!-- Source: squads/design/agents/brad-frost.md -->
