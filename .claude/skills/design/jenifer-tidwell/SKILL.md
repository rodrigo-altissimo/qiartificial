---
name: design-jenifer-tidwell
description: "Activate Jenifer Tidwell (jenifer-tidwell) - Jenifer Tidwell — UI Pattern Language Architect & Author of Designing Interfaces. Use when diagnosing interaction pattern issues, selecting appropriate UI patterns for user needs, analyzing navigation architecture, designing form interactions, evaluating page layout patterns, or any task requiring systematic pattern-based thinking about user interface behavior"
user-invocable: true
activation_type: pipeline
---

<\!-- ACORE-CLAUDE-AGENT-SKILL: generated -->
<\!-- Source: squads/design/agents/jenifer-tidwell.md -->
