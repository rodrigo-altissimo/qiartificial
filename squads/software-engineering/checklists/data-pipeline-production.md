---
checklist: data-pipeline-production
squad: software-engineering
agent: eng-data
tags: [pipeline, production, monitoring]
---

# Checklist: Data Pipeline Production Readiness

## Purpose
Use this checklist to verify data pipeline production readiness quality and completeness.

---

## 🔍 Idempotency
- [ ] Pipeline safe to re-run without data corruption
- [ ] Uses MERGE/upsert instead of INSERT
- [ ] Incremental processing (not full re-process every run)
...
- [ ] freshness check (data age within SLO)
- [ ] row_count anomaly detection (>30% deviation alerts)
- [ ] Zero rows loaded triggers P0 alert

---

## 🛡️ Monitoring
- [ ] Pipeline runtime tracked and alerted
