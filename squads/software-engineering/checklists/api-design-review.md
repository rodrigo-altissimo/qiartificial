...
agent: eng-api
tags: [api, rest, review, quality-gate]
---

# Checklist: API Design Review

## P0 — Showstoppers
- [ ] No verbs in resource URLs (`POST /users` not `POST /createUser`)
- [ ] No sensitive data in URL query params (tokens, passwords, PII)
- [ ] All endpoints behind authentication
- [ ] All input validated and sanitized
- [ ] No internal model/database schema exposed in API response

## Resource Design
- [ ] Resources are nouns, plural, lowercase, hyphen-separated
- [ ] Nested resources max 2 levels deep (`/orders/{id}/items`)
...
- [ ] Error includes: code, message, details, request_id
- [ ] Correct status codes used (400, 401, 403, 404, 409, 422, 429, 500)
...
- [ ] Default page size defined (20-50 items)
- [ ] Maximum page size enforced (100 items)
- [ ] Filtering via query parameters
- [ ] Sorting with `-field` for descending
...
- [ ] Sunset policy defined for deprecated versions

## Documentation
- [ ] OpenAPI/Swagger spec generated from code (not manually written)
