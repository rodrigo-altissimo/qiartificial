---
checklist: api-versioning
squad: software-engineering
agent: eng-api
tags: [api, versioning, breaking-change]
---

# Checklist: API Versioning

## Purpose
Use this checklist to verify api versioning quality and completeness.
...
- [ ] Adding required field to request → BREAKING
- [ ] Adding optional field to response → NON-BREAKING
- [ ] Adding new endpoint → NON-BREAKING

---

## ✅ Version Release Protocol
- [ ] New version number assigned (v2, v3...)
- [ ] Old version sunset date announced (minimum 12 months)
- [ ] Sunset header added to old version responses
- [ ] Migration guide published for consumers
- [ ] Consumer notification sent (email/Slack/changelog)
- [ ] Analytics tracking both versions usage
