---
checklist: owasp-top10
squad: software-engineering
agent: eng-security
tags: [owasp, security, vulnerabilities]
---

# Checklist: OWASP Top 10 Check

## Purpose
Use this checklist to verify owasp top 10 check quality and completeness.

---

## 🔍 Injection (A03)
- [ ] All SQL queries use parameterized queries / ORM
...
- [ ] Session tokens rotated on auth state change
- [ ] JWT expiration set (short-lived + refresh token)

---

## 🛡️ Security Misconfiguration (A05)
