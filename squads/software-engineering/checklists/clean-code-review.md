...
## Purpose
Use this checklist to verify clean code review quality and completeness.

---

## 🔍 Naming
- [ ] Methods/functions describe what they DO (verbs)
- [ ] Variables describe what they HOLD (nouns)
- [ ] No abbreviations unless universally understood
- [ ] Names distinguish between similar concepts
...
- [ ] No side effects hidden in function name
...
- [ ] TODO comments have ticket/issue reference
