...
agent: eng-ddd
tags: [context-map, integration, ddd]
---

# Checklist: Context Map Review

## Purpose
Use this checklist to verify context map review quality and completeness.

---

## 🔍 Relationships
- [ ] All bounded context relationships mapped
- [ ] Relationship type identified: Shared Kernel / Customer-Supplier / Conformist / ACL / OHS
- [ ] Dependencies direction clear (upstream/downstream)

---

## ✅ Integration
- [ ] Integration mechanism defined per relationship (API/events/shared DB)
- [ ] Anti-Corruption Layers in place where needed
