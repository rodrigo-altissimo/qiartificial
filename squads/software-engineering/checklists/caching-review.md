---
checklist: caching-review
squad: software-engineering
agent: eng-perf
tags: [caching, invalidation, performance]
---

# Checklist: Caching Strategy Review

## Purpose
Use this checklist to verify caching strategy review quality and completeness.

---

## 🔍 Cache Design
- [ ] Cache level justified (client/CDN/app/DB)
- [ ] TTL defined per cache key type
- [ ] Invalidation strategy chosen (TTL/write-through/cache-aside)
- [ ] Staleness tolerance documented

---

## ✅ Risks
- [ ] Thundering herd protection (stale-while-revalidate or locking)
- [ ] Cache key collision prevention (namespaced keys)
- [ ] Memory limits set with eviction policy (LRU/LFU)
- [ ] Cache miss behavior defined and tested
