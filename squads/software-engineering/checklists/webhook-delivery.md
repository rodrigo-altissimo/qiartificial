...
## Purpose
Use this checklist to verify webhook delivery quality and completeness.

---

## 🔍 Payload Design
- [ ] Event type included in payload
- [ ] Unique event ID for deduplication
- [ ] Timestamp in ISO-8601 format
- [ ] Payload schema documented for each event type

---

## ✅ Security
- [ ] HMAC-SHA256 signature in X-Webhook-Signature header
- [ ] Shared secret per webhook registration (not global)
- [ ] Consumer verification guide published

---

## 🛡️ Reliability
- [ ] Exponential backoff retry (1m, 5m, 30m, 2h, 24h)
- [ ] Max 5 retries before disabling
- [ ] Owner notified when webhook disabled
