---
checklist: circuit-breaker-config
squad: software-engineering
agent: eng-distributed
tags: [circuit-breaker, resilience, config]
---

# Checklist: Circuit Breaker Configuration

## Purpose
Use this checklist to verify circuit breaker configuration quality and completeness.

---

## 🔍 Thresholds
- [ ] Failure threshold defined (e.g., 5 failures in 60 seconds)
- [ ] Recovery timeout defined (e.g., 30 seconds before HALF-OPEN)
- [ ] Success threshold for HALF-OPEN→CLOSED (e.g., 3 successes)

---

## ✅ Fallback
- [ ] Fallback behavior defined for OPEN state
- [ ] Fallback returns graceful degradation (not error)
- [ ] Fallback behavior documented for consumers

---

## 🛡️ Monitoring
- [ ] Circuit state changes logged and alerted
- [ ] Dashboard shows current state per circuit
- [ ] Metrics: failure rate, open duration, fallback hits
