---
checklist: schema-migration-safety
squad: software-engineering
agent: eng-data
tags: [schema, migration, zero-downtime]
---

# Checklist: Schema Migration Safety

## Purpose
Use this checklist to verify schema migration safety quality and completeness.

---

## 🔍 Pre-Migration
- [ ] Migration is backward compatible (or expand-migrate-contract plan)
- [ ] Up AND down migration scripts included
...
## ✅ During Migration
- [ ] Migration runs within maintenance window (if needed)
- [ ] Progress monitored (rows migrated, time elapsed)
...
- [ ] All consumers confirmed working
- [ ] Old column/table cleanup scheduled (30+ days)
