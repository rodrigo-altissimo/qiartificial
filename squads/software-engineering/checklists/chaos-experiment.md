---
checklist: chaos-experiment
squad: software-engineering
agent: eng-devops
tags: [chaos, resilience, gameday]
---

# Checklist: Chaos Experiment

## Purpose
Use this checklist to verify chaos experiment quality and completeness.

---

## 🔍 Pre-Experiment
- [ ] Hypothesis defined: 'system will [behavior] when [failure]'
- [ ] Blast radius limited (specific service, not entire prod)
- [ ] Rollback mechanism tested before experiment
...
## ✅ During Experiment
- [ ] Failure injected as planned (network, CPU, disk, process)
- [ ] System behavior observed vs hypothesis
- [ ] Customer impact monitored in real-time
- [ ] Abort criteria defined and ready to trigger

---

## 🛡️ Post-Experiment
- [ ] Results documented: hypothesis confirmed/rejected
- [ ] Action items for gaps found
