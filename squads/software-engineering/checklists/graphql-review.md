---
checklist: graphql-review
squad: software-engineering
agent: eng-api
tags: [graphql, schema, performance]
---

# Checklist: GraphQL Schema Review

## Purpose
Use this checklist to verify graphql schema review quality and completeness.

---

## 🔍 Schema Design
- [ ] All types use non-null (!) where appropriate
- [ ] Connections use Relay cursor pagination
- [ ] Input types used for mutations (not inline args)
- [ ] Error types defined with machine-readable codes

---

## ✅ Performance
- [ ] DataLoader implemented for all N+1 risks
- [ ] Query complexity limit set (max 1000)
- [ ] Query depth limit set (max 10)
