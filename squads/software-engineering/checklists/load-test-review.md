---
checklist: load-test-review
squad: software-engineering
agent: eng-perf
tags: [load-test, performance, results]
---

# Checklist: Load Test Results Review

## Purpose
Use this checklist to verify load test results review quality and completeness.

---

## 🔍 Test Configuration
- [ ] SLO targets defined before test (p99 < Xms at Y RPS)
- [ ] Test scenarios realistic (user journeys, not just GETs)
- [ ] Test data production-like (not empty DB)
- [ ] Test duration adequate (>= 30 minutes sustained)

---

## ✅ Results Analysis
- [ ] p50/p90/p95/p99 latency recorded
- [ ] Error rate during test < SLO
- [ ] Breaking point identified (at what RPS does system degrade)
- [ ] Server resources monitored during test (CPU, memory, connections)

---

## 🛡️ Actions
- [ ] Bottleneck identified if SLO breached
- [ ] Capacity plan updated based on results
- [ ] Next test scheduled with improvements
