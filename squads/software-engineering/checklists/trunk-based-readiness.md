---
checklist: trunk-based-readiness
squad: software-engineering
agent: eng-agile
tags: [trunk-based, branching, ci]
---

# Checklist: Trunk-Based Development Readiness

## Purpose
Use this checklist to verify trunk-based development readiness quality and completeness.

---

## 🔍 Prerequisites
- [ ] CI pipeline runs all tests in < 15 minutes
- [ ] Feature flags infrastructure available
- [ ] Code review turnaround < 4 hours
- [ ] Team comfortable with small, frequent commits

---

## ✅ Practices
- [ ] No long-lived feature branches (max 1 day)
- [ ] All commits pass CI before merge to trunk
- [ ] Feature flags used for in-progress features
- [ ] Pair/mob programming used for complex changes
