---
checklist: dependency-scan
squad: software-engineering
agent: eng-security
tags: [dependencies, vulnerabilities, supply-chain]
---

# Checklist: Dependency Security Scan

## Purpose
Use this checklist to verify dependency security scan quality and completeness.

---

## 🔍 Scan Results
- [ ] Dependency scanner ran (Snyk, npm audit, safety, Trivy)
- [ ] No CRITICAL vulnerabilities in dependencies
- [ ] No HIGH vulnerabilities (or with accepted risk + timeline)
- [ ] MEDIUM vulnerabilities tracked with fix timeline
