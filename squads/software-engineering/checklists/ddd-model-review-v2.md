---
checklist: ddd-model-review-v2
squad: software-engineering
agent: eng-ddd
tags: [ddd, aggregate, bounded-context]
---

# Checklist: DDD Model Review (Deep)

## Purpose
Use this checklist to verify ddd model review (deep) quality and completeness.

---

## 🔍 Aggregate Design
- [ ] Each aggregate has exactly one root entity
- [ ] Aggregate boundary protects invariants
- [ ] References between aggregates by ID only (not object)
- [ ] Aggregate is the unit of consistency

---

## ✅ Bounded Context
- [ ] Each context has ubiquitous language documented
- [ ] No shared database between contexts
- [ ] Context integration via events or ACL
- [ ] Context map shows all relationships

---

## 🛡️ Domain Events
- [ ] Events named in past tense (OrderPlaced, PaymentReceived)
- [ ] Events contain sufficient data (no need to call back)
