...
## Purpose
Use this checklist to verify refactoring safety quality and completeness.

---

## 🔍 Before Refactoring
- [ ] Tests exist covering the code being refactored
- [ ] Characterization tests added if coverage insufficient
- [ ] Scope defined: what will change, what will NOT
- [ ] Commits will be small and frequent

---

## ✅ During Refactoring
- [ ] Each step: one rename/extract/inline at a time
- [ ] Tests run after EVERY step
- [ ] No behavior change (refactoring ≠ rewriting)
- [ ] IDE refactoring tools used when available

---

## 🛡️ After Refactoring
- [ ] All original tests still pass
- [ ] Code smells reduced (measurable)
- [ ] PR description explains refactoring rationale
