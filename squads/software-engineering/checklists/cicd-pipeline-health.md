---
checklist: cicd-pipeline-health
squad: software-engineering
agent: eng-devops
tags: [cicd, pipeline, automation]
---

# Checklist: CI/CD Pipeline Health

## Purpose
Use this checklist to verify ci/cd pipeline health quality and completeness.
...
- [ ] Build reproducible (same commit = same artifact)
