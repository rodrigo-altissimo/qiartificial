...
agent: eng-audit
tags: [release, quality-gate, production]
---

# Checklist: Release Readiness (Full)

## Purpose
Use this checklist to verify release readiness (full) quality and completeness.

---

## 🔍 Security Pillar
- [ ] No hardcoded secrets (scanner ran)
...
## 🛡️ Operability Pillar
- [ ] Structured logging in place
- [ ] Health check endpoint exists
- [ ] Metrics exported (4 golden signals)
