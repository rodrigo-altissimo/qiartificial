...
## Purpose
Use this checklist to verify slo definition quality and completeness.

---

## 🔍 SLO Targets
- [ ] Availability SLO defined (e.g., 99.9%)
- [ ] Latency SLO defined per endpoint (p99 < Xms)
- [ ] Error rate SLO defined (< X%)
- [ ] Freshness SLO for data pipelines (if applicable)

---

## ✅ Error Budget
- [ ] Error budget calculated (1 - SLO target)
- [ ] Budget consumption tracked in dashboard
- [ ] Burn-rate alert configured (fast and slow burn)
- [ ] Budget exhaustion policy defined (freeze features vs continue)

---

## 🛡️ Review Cadence
- [ ] Monthly SLO review meeting scheduled
- [ ] SLO attainment report auto-generated
- [ ] SLO revision process documented
