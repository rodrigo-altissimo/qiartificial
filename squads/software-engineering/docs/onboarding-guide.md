...
> Agent: eng-chief | Squad: software-engineering

## Overview
How to onboard new agents into the software engineering squad.

## When to Use
- When the team needs guidance on agent onboarding guide
...
## Related
- Agent: eng-chief | Task: see tasks/ | Checklist: see checklists/


## Core Principles

### 1. Route to Specialists
The chief engineer triages requests and routes to the right agent.

### 2. DORA Metrics Matter
Deployment Frequency, Lead Time, MTTR, Change Failure Rate.

### 3. Escalation Protocol
Clear escalation paths with defined triggers and response times.
