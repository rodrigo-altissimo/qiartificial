...
> Agent: eng-audit | Squad: software-engineering

## Overview
Brazilian data protection law requirements and technical checklist.

## When to Use
- When the team needs guidance on lgpd compliance guide
...
## Related
- Agent: eng-audit | Task: see tasks/ | Checklist: see checklists/
