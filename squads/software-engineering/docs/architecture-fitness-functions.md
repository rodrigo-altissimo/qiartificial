...
## Overview
Automated governance for architecture characteristics.

## When to Use
- When the team needs guidance on architecture fitness functions
...
## Blueprint: Architecture Decision Framework

### 1. ADR Template (Production-Ready)
...
- Technical constraint: [any limitations]
- Current state: [how things work today]
- Quality attributes: [which -ilities matter most]
...
```
╔══════════════════════════════════════════════════════════════╗
║          ARCHITECTURE CHARACTERISTICS PRIORITY              ║
║         (pick 3-5, you CANNOT have all of them)            ║
╠══════════════════════════════════════════════════════════════╣
║                                                              ║
║ OPERATIONAL:                                                 ║
║   □ Availability (99.9% = 8.7h/year downtime)               ║
║   □ Performance (p99 latency target: ___ms)                 ║
║   □ Scalability (handle ___x current load)                   ║
║   □ Reliability (data durability, fault tolerance)           ║
║   □ Recoverability (RPO: ___, RTO: ___)                     ║
║                                                              ║
║ STRUCTURAL:                                                  ║
║   □ Maintainability (ease of change)                         ║
║   □ Modularity (independent components)                      ║
║   □ Testability (ease of automated testing)                  ║
║   □ Deployability (deploy frequency target: ___)             ║
...
║   □ Cost (infrastructure budget: R$___/month)                ║
║                                                              ║
║ SELECTED TOP 5 (ordered by priority):                        ║
