---
task: design-chaos-engineering
squad: software-engineering
agent: eng-devops
tags: [chaos, resilience, testing]
---

# Task: Design Chaos Engineering Experiment

## Purpose
Design controlled chaos experiments to verify system resilience (network, CPU, disk, process failures).
