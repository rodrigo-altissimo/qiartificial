...
agent: eng-api
tags: [contract-testing, pact, api]
---

# Task: Implement API Contract Testing

## Purpose
Set up consumer-driven contract testing between services using Pact or similar framework.
