...
agent: eng-audit
tags: [compliance, lgpd, gdpr]
---

# Task: Run LGPD/GDPR Compliance Audit

## Purpose
Audit the system for LGPD/GDPR compliance: PII handling, consent, deletion rights, breach notification.
