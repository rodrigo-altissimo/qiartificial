---
task: design-zero-trust-api
squad: software-engineering
agent: eng-security
tags: [zero-trust, security, api]
---

# Task: Design Zero Trust API Security

## Purpose
Implement zero-trust principles: verify every request, least privilege, assume breach.
...
## Quality Gate
- Solution reviewed by eng-security
