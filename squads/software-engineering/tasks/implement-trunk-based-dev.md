---
task: implement-trunk-based-dev
squad: software-engineering
agent: eng-agile
tags: [trunk-based, branching, ci]
---

# Task: Implement Trunk-Based Development

## Purpose
Migrate from feature branches to trunk-based development with feature flags and CI gates.
