---
task: implement-data-quality
squad: software-engineering
agent: eng-data
tags: [data-quality, testing, pipeline]
---

# Task: Implement Data Quality Framework

## Purpose
Implement automated quality checks (not_null, unique, freshness, volume) across data pipelines.
