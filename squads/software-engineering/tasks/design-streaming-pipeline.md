---
task: design-streaming-pipeline
squad: software-engineering
agent: eng-data
tags: [streaming, kafka, real-time]
---

# Task: Design Streaming Data Pipeline

## Purpose
Design real-time streaming pipeline with Kafka, exactly-once semantics, and dead letter queues.
