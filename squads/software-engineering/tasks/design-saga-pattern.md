---
task: design-saga-pattern
squad: software-engineering
agent: eng-distributed
tags: [saga, distributed-transaction, choreography]
---

# Task: Design Saga Pattern

## Purpose
Design distributed transaction using saga pattern (choreography vs orchestration) with compensation.
