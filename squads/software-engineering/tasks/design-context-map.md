---
task: design-context-map
squad: software-engineering
agent: eng-ddd
tags: [context-map, ddd, bounded-context]
---

# Task: Design DDD Context Map

## Purpose
Map the relationships between bounded contexts: Shared Kernel, Conformist, ACL, Open Host Service.
