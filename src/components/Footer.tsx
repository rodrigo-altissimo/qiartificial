...
const Footer = () => {
  ...
  return (
    <footer className="bg-qiartificial-900 text-gray-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4 mt-6">
              <a 
                href="#" 
                className="bg-qiartificial-800 hover:bg-qiartificial-700 p-2 rounded-full transition-colors"
                aria-label="LinkedIn"
              >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center">
                <Phone className="h-5 w-5 mr-2 text-qiartificial-400" />
                <span>(11) 9999-9999</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 mr-2 text-qiartificial-400" />
                <span>contato@qiartificial.com.br</span>
              </li>
              <li className="flex items-center">
                <MessageSquare className="h-5 w-5 mr-2 text-qiartificial-400" />
                <a 
