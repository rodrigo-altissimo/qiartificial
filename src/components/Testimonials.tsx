...
const Testimonials = () => {
  return (
    <section id="depoimentos" className="section-padding bg-black">
      <div className="container-narrow">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">O que nossos <span className="text-green-400">clientes</span> dizem</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <Card key={index} className="card-hover bg-black/60 backdrop-blur-sm border border-green-900/30">
              <CardHeader className="pb-2">
                <div className="flex justify-center">
                  <div className="relative">
                    ...
                    <Avatar className="h-16 w-16 border-2 border-black relative">
